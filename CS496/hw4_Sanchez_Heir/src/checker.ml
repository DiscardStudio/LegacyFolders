...
open Dst
(**
  Names: Michael Sanchez, Simrun Heir
...
declaration")
  ...
  | Node(de, le, re) ->
    type_of_expr le >>=
    arg_of_treeType "tree: " >>= fun l ->
    type_of_expr re >>=
    arg_of_treeType "tree: " >>= fun r ->
  ...
  | GetData(t) ->
    type_of_expr t >>= 
    arg_of_treeType "getData: " >>= fun tr ->
    return tr 
  | GetLST(t) ->
    type_of_expr t >>= 
    arg_of_treeType "getLST: " >>= fun tr ->
    return (TreeType(tr))  
  | GetRST(t) ->
    type_of_expr t >>= 
    arg_of_treeType "getRST: " >>= fun tr ->
    return (TreeType(tr))
